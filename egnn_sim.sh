...
./util/job_launching/run_simulations.py -B ExpressGNN -C A100-SASS -T ./hw_run/traces/device-2/12.8/ -N egnn_A100-SASS
...
#./util/job_launching/monitor_func_test.py -v -N egnn_A100-bypass
